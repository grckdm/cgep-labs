...
# Formerly non-compliant (SC-28): now has a CMEK encryption block.
...
# Formerly non-compliant (AC-3): now locked down.
...
# Formerly non-compliant (CM-6): now carries all required labels.
